...
const naoya = {
  ...
  goal: "Become a Great Engineer 💪",
  interests: ["📷 Camera", "🖥️ Home Electronics & PC", "🎧 Music"],
  currentlyLearning: ["Web Development", "Software Engineering"],
  funFact: "I love exploring new technologies and creative tools!"
};
```
...
- 🔥 **Learning Programming** - Working hard to become an engineer
- 🎨 **Design Skills** - Creating beautiful designs with Figma & Illustrator
- 📸 **Photography** - Capturing moments and exploring camera techniques
- 🎵 **Music** - Discovering new sounds and artists

---

## 💡 Interests & Hobbies

- 📷 **Photography** - Love capturing beautiful moments
- 🖥️ **Home Electronics & PC** - Building and customizing setups
- 🎧 **Music** - Always exploring new genres and artists
- 💻 **Technology** - Passionate about learning new tech trends
...
### ⚡ Fun Fact
*I'm always learning something new and excited about the journey to become an engineer!* 🚀
